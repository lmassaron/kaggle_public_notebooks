...
| Tutorial Bayesian Optimization with CatBoost | [Link](httpshttps://www.kaggle.com/code/lucamassaron/tutorial-bayesian-optimization-with-catboost) | A notebook that provides a tutorial on how to use Bayesian optimization with CatBoost. |
